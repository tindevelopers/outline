...
If your team is using Slack to communicate then you’ll definitely want to enable our [Slack Integration](/settings/integrations/slack) to get instant link unfurling for TIN Vault documents and access to the `/outline` slash command to search your knowledge base directly from Slack.
...
curl -XPOST -H "Content-type: application/json" -d '{
  ...
  "token": "API_TOKEN", // get an API token from Settings → API & Access in your workspace
  "publish": true
